                        ...
                        <form action="">
                            ...
                            <div className='block '>
                                ...
                                <div className='grid mx-3' >
                                    ...
                                    <input type="email" name='email' style={{borderRadius:"6px", backgroundColor:"#e0d7d7", textAlign:"center"}} placeholder='email address'/>
                                </div>

                                {/* password div */}
                                <div className='grid mx-3 lato-4'>
                                    <label htmlFor="name">Password</label>
                                    <input type="password" name='password' style={{borderRadius:"6px", backgroundColor:"#e0d7d7", textAlign:"center"}} placeholder='password'/>
                                </div>
                                ...
                                <div className='btn flex justify-center'>
                                    <button className='bg-stone-950 text-white w-11/12 items-center py-1 ' style={{borderRadius:"10px"}}>Sign In</button>
                                </div>
